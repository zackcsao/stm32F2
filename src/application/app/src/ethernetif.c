...
void ethernetif_set_link(struct netif *netif)
{
  ...
  if (sys_func.sys_get_msec() - EthernetLinkTimer >= 200)
  {
    EthernetLinkTimer = sys_func.sys_get_msec(); 
...
void ethernetif_update_config(struct netif *netif)
{
  ...
  { 
    ...
    if(heth.Init.AutoNegotiation != ETH_AUTONEGOTIATION_DISABLE)
    {
      ...
      /* Get tick */
      tickstart = sys_func.sys_get_msec();
      ...
      do
      {
        ...
        if((sys_func.sys_get_msec() - tickstart ) > 1000)
        {     
          /* In case of timeout */ 
          goto error;
        }   
