...
//	uart_send(&lcd_uart,(uint8_t *)"CIR(10,10,3,1);\r\n",strlen("CIR(10,10,3,1);\r\n"));
	uart_send(&lcd_uart,(uint8_t *)"CLR(0);SBC(3);DC24(0,100,'Uart 显示屏',1);DC24(0,100,'Uart 显示屏0',1);\r\n",
				strlen("CLR(0);SBC(3);DC24(0,100,'Uart 显示屏',1);DC24(0,100,'Uart 显示屏0',1);\r\n"));
	uart_send(&lcd_uart,(uint8_t *)"CLR(0);SBC(3);DC24(0,100,'Uart 显示屏',1);DC24(0,100,'Uart 显示屏1',1);\r\n",
				strlen("CLR(0);SBC(3);DC24(0,100,'Uart 显示屏',1);DC24(0,100,'Uart 显示屏1',1);\r\n"));
	uart_send(&lcd_uart,(uint8_t *)"CLR(0);SBC(3);DC24(0,100,'Uart 显示屏',1);DC24(0,100,'Uart 显示屏2',1);\r\n",
				strlen("CLR(0);SBC(3);DC24(0,100,'Uart 显示屏',1);DC24(0,100,'Uart 显示屏2',1);\r\n"));

//	uart_send(&lcd_uart,(uint8_t *)"CLR(0);SBC(3);DC12(0,0,'Uart 显示屏',1);DC24(0,20,'Uart 显示屏2',1);DC32(0,48,'Uart 显示屏3',1);DCV16(0,84,'Uart 显示屏4',1);DCV24(0,104,'Uart 显示屏5',1);DCV32(0,132,'Uart 显示屏6',1);PL(0,170,175,170,1);BOXF(110,180,170,210,1);CIR(50,195,20,1);\r\n",
//				strlen("CLR(0);SBC(3);DC16(0,0,'Uart 显示屏',1);DC24(0,20,'Uart 显示屏2',1);DC32(0,48,'Uart 显示屏3',1);DCV16(0,84,'Uart 显示屏4',1);DCV24(0,104,'Uart 显示屏5',1);DCV32(0,132,'Uart 显示屏6',1);PL(0,170,175,170,1);BOXF(110,180,170,210,1);CIR(50,195,20,1);\r\n"));
